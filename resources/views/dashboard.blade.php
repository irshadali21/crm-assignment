            ...
            <div class="nk-content-body">
                    ...
                    <div class="row g-gs">
                            ...
                            <div class="card card-full bg-primary">
                                <div class="card-inner">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <div class="fs-6 text-white text-opacity-75 mb-0">Words Available</div><a href="/copywriter/history.html"
                                            class="link link-white">See History</a>
                                    </div>
                                ...
                                <div class="card-inner">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <div class="fs-6 text-white text-opacity-75 mb-0">Drafts Available</div><a
                                            href="/copywriter/document-drafts.html" class="link link-white">See All</a>
                                    </div>
                                    <h5 class="fs-1 text-white">3 <small class="fs-3">Drafts</small></h5>
                                    <div class="fs-7 text-white text-opacity-75 mt-1"><span class="text-white">7</span>/10 free drafts
                                        created</div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-inner">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <div class="fs-6 text-white text-opacity-75 mb-0">Documents Available</div><a
                                            href="/copywriter/document-saved.html" class="link link-white">See All</a>
                                    </div>
                        ...
                        <div class="col-sm-6 col-xxl-3">
                            <div class="card card-full bg-danger is-dark">
                                <div class="card-inner">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <div class="fs-6 text-white text-opacity-75 mb-0">Tools Available</div><a href="/copywriter/templates.html"
                                            class="link link-white">All Tools</a>
                                    </div>
                                    <h5 class="fs-1 text-white">12 <small class="fs-3">Tools</small></h5>
                                    <div class="fs-7 text-white text-opacity-75 mt-1"><span class="text-white">4</span>/16 tools used to
                                        generate</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="nk-block-head">
                    <div class="nk-block-between">
                        ...
                        <div class="nk-block-head-content"><a href="/copywriter/templates.html" class="link">Explore All</a></div>
                    </div>
                </div>
                <div class="nk-block">
                    <div class="row g-gs">
                        <div class="col-sm-6 col-xxl-3">
                            <div class="card card-full">
                                <div class="card-inner">
                                    <div class="user-avatar text-primary bg-primary-dim mb-3"><em class="icon ni ni-bulb-fill"></em>
                                    </div>
                        ...
                        <div class="col-sm-6 col-xxl-3">
                            <div class="card card-full">
                                <div class="card-inner">
                                    ...
                                    <div class="user-avatar text-blue bg-blue-dim mb-3"><em class="icon ni ni-spark-fill"></em></div>
                        ...
                        <div class="col-sm-6 col-xxl-3">
                            <div class="card card-full">
                                <div class="card-inner">
                                    <div class="user-avatar text-danger bg-danger-dim mb-3"><em class="icon ni ni-youtube-fill"></em>
                                    </div>
                        ...
                        <div class="col-sm-6 col-xxl-3">
                            <div class="card card-full">
                                <div class="card-inner">
                                    <div class="user-avatar text-purple bg-purple-dim  mb-3"><em class="icon ni ni-laptop"></em></div>
                ...
                <div class="nk-block-head">
                    <div class="nk-block-between">
                        ...
                        <div class="nk-block-head-content"><a href="/copywriter/document-saved.html" class="link"><span>See
                                    All</span> <em class="icon ni ni-chevron-right"></em></a></div>
                    </div>
                </div>
                <div class="nk-block">
                    <div class="card">
                                ...
                                <tr class="nk-tb-item nk-tb-head">
                                    <th class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext"><input type="checkbox"
                                                class="custom-control-input" id="did-all"><label class="custom-control-label"
                            ...
                            <tbody>
                                <tr class="nk-tb-item">
                                    <td class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext"><input type="checkbox"
                                                class="custom-control-input" id="did-01"><label class="custom-control-label"
                                    ...
                                    <td class="nk-tb-col tb-col-end">
                                        <div class="dropdown"><button class="btn btn-sm btn-icon btn-trigger me-n1" type="button"
                                                data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></button>
                                ...
                                <tr class="nk-tb-item">
                                    <td class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext"><input type="checkbox"
                                                class="custom-control-input" id="did-02"><label class="custom-control-label"
                                ...
                                <tr class="nk-tb-item">
                                    <td class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext"><input type="checkbox"
                                                class="custom-control-input" id="did-03"><label class="custom-control-label"
                                ...
                                <tr class="nk-tb-item">
                                    <td class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext"><input type="checkbox"
                                                class="custom-control-input" id="did-04"><label class="custom-control-label"
                                                for="did-04"></label></div>
                                    </td>
                                    <td class="nk-tb-col">
                                        <div class="caption-text">Transforming Healthcare with Big Data: Exploring the Opportunities
                                        </div>
                                    </td>
                                    <td class="nk-tb-col tb-col-sm">
