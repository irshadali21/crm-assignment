                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <div class="nk-block-head-sub"><a class="back-to" href="/demo9/components.html"><em
                                            class="icon ni ni-arrow-left"></em><span>Components</span></a></div>
                                <h2 class="nk-block-title fw-normal">All Companies</h2>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle"><a class="btn btn-icon btn-trigger toggle-expand me-n1"
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li class="nk-block-tools-opt"><a onclick="openModal('create', '{{ route('companies.create') }}')"
                                                    class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Add New Company</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
